"use strict";
console.log('\n\nStrings');
let testPhrase1 = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit';
let testPhrase2 = 'sed do eiusmod tempor incididunt ut labore et dolore magna aliqua';
let testPhrase3 = 'Ut enim ad minim veniam, quis nostrud exercitation';
...
console.log('\n\nRegex');
let regNumber = /^\d+$/;
let regEmail = /^[A-Za-z0-9_!#$%&'*+\/=?`{|}~^.-]+@[A-Za-z0-9.-]+$/gm;
let regPhoneNr = /^(\([0-9]{3}\) |[0-9]{3}-)[0-9]{3}-[0-9]{4}/;
let regFilePath = /^[a-z]:((\\|\/)[a-z0-9\s_@\-^!#$%&+={}\[\]]+)+\.xml$/i;
let regHTMLtags = /<[a-z][\s\S]*>/i;
